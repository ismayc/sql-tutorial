...
-- Write your SQL query here to select airlines with names starting with a specific letter.
```
...
-- Write your SQL query here to select flights with tail numbers matching a specific pattern.
```
