...
`MIN` and `MAX` return a number, not the row that number came from. To get the row, compute the number in an inner query and compare against it in the outer one.
