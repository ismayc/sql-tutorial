...
import { aggregateAct } from "../../lib/scrolly-diagrams-more.mjs";
...
To find the *row* behind a minimum or maximum (which town is smallest, which county is oldest), see the subquery examples in <a href={`${import.meta.env.BASE_URL}examples/going-further#scrolly-subquery`}>Going Further</a>.
