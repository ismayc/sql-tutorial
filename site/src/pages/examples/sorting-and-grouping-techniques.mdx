...
import { clauseOrderAct, groupByAct } from "../../lib/scrolly-diagrams-sql.mjs";
import { orderByAct } from "../../lib/scrolly-diagrams-more.mjs";
...
<Scrolly act={clauseOrderAct} swap />
