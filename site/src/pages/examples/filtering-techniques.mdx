...
import { wherePrecedenceAct } from "../../lib/scrolly-diagrams-sql.mjs";
import { betweenInAct, likeAct, nullAct } from "../../lib/scrolly-diagrams-more.mjs";
...
<Scrolly act={wherePrecedenceAct} swap />
