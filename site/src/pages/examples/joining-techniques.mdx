...
import { innerAct, leftAct, multiAct, antiAct } from "../../lib/scrolly-diagrams.mjs";
...
Two more join examples combine a join with `GROUP BY`: counting towns per county (including the counties with none) and a full county dashboard. They are in <a href={`${import.meta.env.BASE_URL}examples/going-further#scrolly-count-after-left-join`}>Going Further</a>.
