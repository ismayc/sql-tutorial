...
import { selectColumnsAct, distinctAct, countAct } from "../../lib/scrolly-diagrams-more.mjs";
...
<Scrolly act={selectColumnsAct} swap />
...
`COUNT` comes in three forms, and they disagree as soon as a column has `NULL`s or repeats in it. Scroll to watch each one tally the same six rows.

<Scrolly act={countAct} swap />
