...
### Average population across all towns in Washington
...
### Total population across all towns in Oregon
...
### Minimum population across all towns
...
### Maximum population across all towns
...
### Sorting towns by 2020 census population
```{sql, output.var="sql_results"}
...
### Sorting towns by 2020 census population in ascending and descending order
- Ascending:
  ```{sql, output.var="sql_results"}
  SELECT town, population_2020_census
    FROM pnw_towns
...
### Sorting counties by state and population in 2022
```{sql, output.var="sql_results"}
...
### Grouping and ordering counties by state and average population
```{sql, output.var="sql_results"}
...
### Classifying towns by population size using CASE WHEN
...
### Percentage increase in population from 2010 to 2020
...
### Join towns with counties where the primary county matches:
```{sql, output.var="sql_results"}
...
### Are there any towns without county data listed?
...
### List all counties and their corresponding town data (including counties without town data):
```{sql, output.var="sql_results"}
...
### Find counties that don't have any towns listed:
```{sql, output.var="sql_results"}
SELECT c.county
 FROM pnw_counties AS c
