...
-- SOLUTION: This query selects flights with tail numbers that have '101' as the third, fourth, and fifth characters.
SELECT tailnum 
FROM flights 
...
grade_this({
  .solution_query21 <- "SELECT MIN(dest) AS first_sea_dest FROM flights WHERE dest = 'SEA';"
